...
console.log('This script populates some test albums, musicians, genres and albuminstances to your database. Specified database as argument - e.g.: populatedb mongodb://your_username:your_password@your_dabase_url');
